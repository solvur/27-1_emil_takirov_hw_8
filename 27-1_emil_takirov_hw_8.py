...
create_product(connection, ('Тойбосс сендвич', 75.89, 5))
...
create_product(connection, ('Вода со вкусом лайма', 49.99, 9))
create_product(connection, ('Сникес', 120.34, 15))
...
create_product(connection, ('Чипсы со вкусом сыра', 123.79, 8))
create_product(connection, ('Холс', 34.45, 17))
create_product(connection, ('Дирол', 35.23, 10))
